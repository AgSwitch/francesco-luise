...
const Logo = ({className='mb-[180px]', titleClass="text-4xl md:text-6xl", descriptionClass="text-2xl md:text-4xl", logoSize=400}) => {
    ...
    return (
        <div className={`relative flex flex-col items-center gap-2 md:gap-5 z-40 md:mb-0 ${className} overflow=x-hidden`}>
            <Image
                ...
                height={logoSize}
                alt="logo"
                className="absolute top-1/2 -translate-y-1/2 -z-10 rounded-full opacity-80"
            />
